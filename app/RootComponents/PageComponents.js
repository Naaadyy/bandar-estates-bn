...
export default function PageComponents() {
  return (
    ...
    <div className="boxes mx-auto px-5 py-12 sm:py-24 sm:max-w-screen-xl flex flex-col sm:flex-row justify-between">
          <div className="start-left w-full sm:w-1/2 h-60 bg-yellow-400 text-black flex flex-col justify-center items-center">
          ...
          <div className="loan-right w-full sm:w-1/2 h-60 bg-yellow-400 text-black flex flex-col justify-center items-center mt-8 sm:mt-0 sm:ml-20">
